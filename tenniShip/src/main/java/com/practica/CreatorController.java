...
public class CreatorController {
	...
	public String tournament (Model model,@ModelAttribute ("newTournament") Tournament tour) {
	...
	public String prueba (Model model,@RequestParam String team1,@RequestParam String team2,@RequestParam String team3,@RequestParam String team4
			,@RequestParam String team5,@RequestParam String team6,@RequestParam String team7,@RequestParam String team8,@RequestParam String team9
			,@RequestParam String team10,@RequestParam String team11,@RequestParam String team12,@RequestParam String team13,@RequestParam String team14
			,@RequestParam String team15,@RequestParam String team16,@RequestParam String team17,@RequestParam String team18) {
